 ...
 * @author josh_pc
 */
public class IniciarIngles extends javax.swing.JFrame {

    /**
     * Creates new form Iniciar
     */
    public IniciarIngles() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Please wait while the process completes...");

        jButtonRepetir.setText("Re-execute process");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IniciarIngles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IniciarIngles().setVisible(true);
            }
        });
    }
