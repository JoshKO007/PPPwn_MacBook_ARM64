...
public class ControladorAplicacion implements ActionListener{
    ...
    private PrincipalIngles PrincipalEn;
    
    public ControladorAplicacion(PrincipalIngles objPrincipalIn){
        this.PrincipalEn = objPrincipalIn;
    }
    ...
    public ControladorAplicacion(Principal objVentana){
        ...
        this.objVentanaPrincipal.jMenuEsp.addActionListener(this);
        this.objVentanaPrincipal.jMenuIngles.addActionListener(this);
    }
...
if (e.getActionCommand().equals("Iniciar")) {
    ...
    int option = JOptionPane.showConfirmDialog(null, passwordField,
            "Ingrese su contraseña sudo:", JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE);
